...
const Editarticle = () => {
  ...
  const handleUpdate=async(e)=>{
    try{
      e.preventDefault()
      await axios.put(`http://localhost:3001/api/articles/${id}`,article).then(res=>{
       navigate("/articles")
      })
  ...
  return (
    <div className='col-md-6 offset-md-3 border rounded p-4 mt-2 shadow'>
      ...
      <Form>
        ...
        <div>
          &nbsp;
          <button className='btn btn-success btn-sm' onClick={(e)=>handleUpdate(e)}><i class="fa-solid fa-floppy-disk"></i> Enregister</button>
          &nbsp;
